...
def calculate_feature_importance(file_path):
    ...
    plt.ylabel('Features')
    plt.title('Feature Importance from Coefficients and Permutation')
...
if __name__ == "__main__":
    ...
    feature_importance = calculate_feature_importance(file_path)
